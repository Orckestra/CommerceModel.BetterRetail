...
BEGIN
	...
	INSERT [dbo].[TEMPLATEVARIABLE] ([TemplateVariable_Id], [Name], [ScopeName], [Description], [Created], [CreatedBy], [LastModified], [LastModifiedBy]) VALUES (N'822a10ff-c4bc-4bad-8f30-268b0f5e65f7', N'OrderReturnCenterContactPhoneNumber', N'Global', N'Order Return Center Contact Phone Number', GETUTCDATE(), 'SYSTEM', GETUTCDATE(), 'SYSTEM')
...
BEGIN
	...
	INSERT [dbo].[TEMPLATEVARIABLE] ([TemplateVariable_Id], [Name], [ScopeName], [Description], [Created], [CreatedBy], [LastModified], [LastModifiedBy]) VALUES (N'667077d9-45e1-47f7-9f12-67a135c40adf', N'OrderReturnCenterContactEmail', N'Global', N'Order Return Center Contact Email', GETUTCDATE(), 'SYSTEM', GETUTCDATE(), 'SYSTEM')
...
BEGIN
	...
	INSERT [dbo].[TEMPLATEVARIABLE] ([TemplateVariable_Id], [Name], [ScopeName], [Description], [Created], [CreatedBy], [LastModified], [LastModifiedBy]) VALUES (N'1eaf3f0d-d006-4653-abde-c24f290a3fb0', N'OrderReturnCenterBaseUrl', N'Global', N'Order Return Center Base Url', GETUTCDATE(), 'SYSTEM', GETUTCDATE(), 'SYSTEM')
